...
<!-- Mirrored from layerdrops.com/insur/main-html/index4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jul 2023 02:49:19 GMT -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title> Home Four || Insur || Insur HTML 5 Template </title>
    <!-- favicons Icons -->
    ...
    <div class="page-wrapper">
                    ...
                    <div class="main-menu-four__wrapper-inner">
                        <div class="main-menu-four__left">
                            <div class="main-menu-four__logo">
                                <a href="index.html"><img src="assets/images/update-10-02-2023/resources/logo-3.png"
                                        alt=""></a>
                            </div>
                        </div>
                            ...
                            <div class="main-menu-four__top">
                                ...
                                <div class="main-menu-four__top-social-btn">
                                    ...
                                    <div class="main-menu-four__btn-box">
                                        <a href="contact.html" class="thm-btn-two main-menu-four__btn">Get a Quote</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="main-slider-four__img">
                            <img src="assets/images/update-10-02-2023/resources/main-slider-four-img-1.jpg" alt="">
                        </div>
                        <!-- /.image-layer -->

                        <div class="main-slider-four__shape-1 float-bob-y">
                            <img src="assets/images/update-10-02-2023/shapes/main-slider-four-shape-1.png" alt="">
                        </div>
                        <div class="main-slider-four__shape-2 float-bob-x">
                            <img src="assets/images/update-10-02-2023/shapes/main-slider-four-shape-2.png" alt="">
                        </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="main-slider-four__content">
                                        ...
                                        <div class="main-slider-four__btn-box">
                                            <a href="about.html" class="thm-btn-two main-slider-four__btn">Discover
                                                More</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <ul class="list-unstyled feature-five__list">
                    <li>
                        <div class="feature-five__single">
                            ...
                            <h3 class="feature-five__title"><a href="#">Safe your money</a></h3>
                            <p class="feature-five__text">Lorem ipsum dolor amet consectetur adipiscing elit do eiusmod
                    ...
                    <li>
                        <div class="feature-five__single">
                            ...
                            <h3 class="feature-five__title"><a href="#">Get free quote</a></h3>
                            <p class="feature-five__text">Lorem ipsum dolor amet consectetur adipiscing elit do eiusmod
                                tempor incid idunt ut labore.</p>
                        </div>
                    </li>
                    <li>
                        <div class="feature-five__single">
                            ...
                            <h3 class="feature-five__title"><a href="#">Fast & reliable</a></h3>
                            <p class="feature-five__text">Lorem ipsum dolor amet consectetur adipiscing elit do eiusmod
                                tempor incid idunt ut labore.</p>
                        </div>
                    </li>
                        ...
                        <div class="about-five__left">
                            <div class="about-five__img-box wow slideInLeft" data-wow-delay="100ms"
                                ...
                                <div class="about-five__img">
                                    <img src="assets/images/update-10-02-2023/resources/about-five-img-1.jpg" alt="">
                                </div>
                                <div class="about-five__img-two">
                                    <img src="assets/images/update-10-02-2023/resources/about-five-img-2.jpg" alt="">
                                </div>
                                ...
                                <div class="about-five__arrow float-bob-x">
                                    <img src="assets/images/update-10-02-2023/shapes/about-five-arrow.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="about-five__points-and-counter-box">
                                <div class="about-five__points-box">
                                    ...
                                    <div class="about-five__btn-box">
                                        <a href="about.html" class="thm-btn-two about-five__btn">Discover More</a>
                                    </div>
                                </div>
        ...
        <section class="services-four">
            <div class="services-four__bg"
                style="background-image: url(assets/images/update-10-02-2023/backgrounds/services-four-bg.jpg);"></div>
            <div class="container">
                ...
                <div class="owl-carousel owl-theme thm-owl__carousel services-four__carousel" data-owl-options='{
                        ...
                        <div class="services-four__single">
                            <div class="services-four__img-box">
                                <div class="services-four__img">
                                    <img src="assets/images/update-10-02-2023/services/services-4-1.png" alt="">
                                </div>
                            ...
                            <div class="services-four__content-box">
                                <div class="services-four__content">
                                    <h4 class="services-four__title"><a href="car-insurance.html">Car insurance</a></h4>
                    ...
                    <div class="item">
                        <div class="services-four__single">
                            <div class="services-four__img-box">
                                <div class="services-four__img">
                                    <img src="assets/images/update-10-02-2023/services/services-4-2.png" alt="">
                                </div>
                                <div class="services-four__icon">
                            ...
                            <div class="services-four__content-box">
                                <div class="services-four__content">
                                    <h4 class="services-four__title"><a href="life-insurance.html">Life insurance</a>
                                    </h4>
                                    <p class="services-four__text">Fusce pretium sem ism <br>
                                        the eget mattis.</p>
                                </div>
                    ...
                    <div class="item">
                        <div class="services-four__single">
                            <div class="services-four__img-box">
                                <div class="services-four__img">
                                    <img src="assets/images/update-10-02-2023/services/services-4-3.png" alt="">
                                </div>
                                <div class="services-four__icon">
                            ...
                            <div class="services-four__content-box">
                                <div class="services-four__content">
                                    <h4 class="services-four__title"><a href="home-insurance.html">Home insurance</a>
                                    </h4>
                                    <p class="services-four__text">Fusce pretium sem ism <br>
                                        the eget mattis.</p>
                                </div>
                    ...
                    <div class="item">
                        <div class="services-four__single">
                            <div class="services-four__img-box">
                                <div class="services-four__img">
                                    <img src="assets/images/update-10-02-2023/services/services-4-4.png" alt="">
                                </div>
                                <div class="services-four__icon">
                            ...
                            <div class="services-four__content-box">
                                <div class="services-four__content">
                                    <h4 class="services-four__title"><a href="health-insurance.html">Health
                                            insurance</a>
                                    </h4>
                                    <p class="services-four__text">Fusce pretium sem ism <br>
                                        the eget mattis.</p>
                    ...
                    <div class="item">
                        <div class="services-four__single">
                            <div class="services-four__img-box">
                                <div class="services-four__img">
                                    <img src="assets/images/update-10-02-2023/services/services-4-5.png" alt="">
                                </div>
                                <div class="services-four__icon">
                            ...
                            <div class="services-four__content-box">
                                <div class="services-four__content">
                                    <h4 class="services-four__title"><a href="business-insurance.html">Business
                                            insurance</a>
                                    </h4>
                                    <p class="services-four__text">Fusce pretium sem ism <br>
                                        the eget mattis.</p>
            ...
            <div class="container">
                <div class="tracking-two__inner">
                    ...
                    <div class="tracking-two__btn-box">
                        <a href="about.html" class="thm-btn-two tracking-two__btn">Track Your Claim</a>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-xl-6 col-lg-7">
                        <div class="why-choose-three__left">
                            <div class="why-choose-three__shape-4 float-bob-x">
                                <img src="assets/images/update-10-02-2023/shapes/why-choose-three-shape-4.png" alt="">
                            </div>
                            <div class="section-title-two text-left">
                                <div class="section-title-two__sub-title-box">
                                    <p class="section-title-two__sub-title"> <span
                            ...
                            <div class="why-choose-three__btn-box">
                                <a href="about.html" class="thm-btn-two why-choose-three__btn">Discover More</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-5">
                        <div class="why-choose-three__right">
                            ...
                            <div class="why-choose-three__img">
                                <img src="assets/images/update-10-02-2023/resources/why-choose-three-img.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                        ...
                        <div class="team-three__single">
                            <div class="team-three__img-box">
                                <div class="team-three__img">
                                    <img src="assets/images/update-10-02-2023/team/team-3-1.jpg" alt="">
                                </div>
                            ...
                            <div class="team-three__content">
                                <h3 class="team-three__name"><a href="team-details.html">Mike hardson</a></h3>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="team-three__single">
                            <div class="team-three__img-box">
                                <div class="team-three__img">
                                    <img src="assets/images/update-10-02-2023/team/team-3-2.jpg" alt="">
                                </div>
                                <ul class="list-unstyled team-three__social-two">
                                    <li><a href="#"><i class="fas fa-share-alt"></i></a></li>
                                </ul>
                            ...
                            <div class="team-three__content">
                                <h3 class="team-three__name"><a href="team-details.html">Aleesha brown</a></h3>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="team-three__single">
                            <div class="team-three__img-box">
                                <div class="team-three__img">
                                    <img src="assets/images/update-10-02-2023/team/team-3-3.jpg" alt="">
                                </div>
                                <ul class="list-unstyled team-three__social-two">
                                    <li><a href="#"><i class="fas fa-share-alt"></i></a></li>
                                </ul>
                            ...
                            <div class="team-three__content">
                                <h3 class="team-three__name"><a href="team-details.html">Kevin smith</a></h3>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <div class="team-three__single">
                            <div class="team-three__img-box">
                                <div class="team-three__img">
                                    <img src="assets/images/update-10-02-2023/team/team-3-4.jpg" alt="">
                                </div>
                                <ul class="list-unstyled team-three__social-two">
                                    <li><a href="#"><i class="fas fa-share-alt"></i></a></li>
                                </ul>
                            ...
                            <div class="team-three__content">
                                <h3 class="team-three__name"><a href="team-details.html">Christine eve</a></h3>
        ...
        <section class="counter-two">
            <div class="counter-two__bg-box">
                <div class="counter-two__bg"
                    style="background-image: url(assets/images/update-10-02-2023/backgrounds/counter-two-bg.jpg);">
                </div>
            </div>
            <div class="container">
                <div class="row">
        ...
        <!--Get Insurance Three Start-->
        <section class="get-insurance-three">
            <div class="get-insurance-three__bg"
                style="background-image: url(assets/images/update-10-02-2023/backgrounds/get-insurance-three-bg.png);">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <div class="get-insurance-three__left">
                            <div class="get-insurance-three__img">
                                <img src="assets/images/update-10-02-2023/resources/get-insurance-img-1.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        <div class="get-insurance-three__right">
                            <div class="section-title-two text-left">
                                ...
                                <h2 class="section-title-two__title">Get an insurance quote <br>
                                    to get started</h2>
                            </div>
        ...
        <!--Get Insurance Three End-->

        <!--Testimonial Four Start-->
        <section class="testimonial-four">
            <div class="testimonial-four__bg"
                style="background-image: url(assets/images/update-10-02-2023/backgrounds/testimonial-four-bg.png);">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-4">
                                ...
                                <div class="item">
                                    <div class="testimonial-four__single">
                                        <div class="testimonial-four__single-inner">
                                            ...
                                            <div class="testimonial-four__client-info-box">
                                                <div class="testimonial-four__client-info">
                                                    <h4 class="testimonial-four__client-name">Kevin martin</h4>
                                        ...
                                        <div class="testimonial-four__client-img">
                                            <img src="assets/images/update-10-02-2023/testimonial/testimonial-4-1.jpg"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="item">
                                    <div class="testimonial-four__single">
                                        <div class="testimonial-four__single-inner">
                                            ...
                                            <div class="testimonial-four__client-info-box">
                                                <div class="testimonial-four__client-info">
                                                    <h4 class="testimonial-four__client-name">Christine eve</h4>
                                                    <p class="testimonial-four__client-sub-title">Customers</p>
                                                </div>
                                                <div class="testimonial-four__rating">
                                                    <i class="fa fa-star"></i>
                                        ...
                                        <div class="testimonial-four__client-img">
                                            <img src="assets/images/update-10-02-2023/testimonial/testimonial-4-2.jpg"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                        <div class="news-four__single">
                            <div class="news-four__img">
                                <img src="assets/images/update-10-02-2023/blog/news-4-1.jpg" alt="">
                            </div>
                            <div class="news-four__content">
                                ...
                                <h3 class="news-four__title"><a href="news-details.html">Which allows you to pay down
                                        insurance bills</a></h3>
                                <a href="news-details.html" class="news-four__read-more">Read More <span
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        <div class="news-four__single">
                            <div class="news-four__img">
                                <img src="assets/images/update-10-02-2023/blog/news-4-2.jpg" alt="">
                            </div>
                            <div class="news-four__content">
                                <div class="news-four__date">
                                    <p>26</p>
                                ...
                                <h3 class="news-four__title"><a href="news-details.html">Lorem ipsum dolor sit amet,
                                        consectetur</a></h3>
                                <a href="news-details.html" class="news-four__read-more">Read More <span
                                        class="icon-right-arrow1"></span></a>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                        <div class="news-four__single">
                            <div class="news-four__img">
                                <img src="assets/images/update-10-02-2023/blog/news-4-3.jpg" alt="">
                            </div>
                            <div class="news-four__content">
                                <div class="news-four__date">
                                    <p>26</p>
                                ...
                                <h3 class="news-four__title"><a href="news-details.html">Suspendisse posuere, leo ac
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                            <div class="footer-widget__column footer-widget-two__about">
                                ...
                                <div class="footer-widget-two__about-text-box">
                                    <p class="footer-widget-two__about-text">Aliqua id fugiat nostrud irure ex duis ea
                        ...
                        <div class="col-xl-2 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                            <div class="footer-widget__column footer-widget-two__links clearfix">
                                ...
                                <ul class="footer-widget-two__links-list list-unstyled clearfix">
                                    <li><a href="about.html">About</a></li>
                                    <li><a href="insurance-01.html">Insurance</a></li>
                                    ...
                                    <li>
                                        ...
                                        <div class="footer-widget-two__latest-news-content">
                                            ...
                                            <h4 class="footer-widget-two__latest-news-title"><a
                                                    href="news-details.html">Our Insurance Strategy <br> for Large
                                                    Business</a></h4>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="footer-widget-two__latest-news-img">
                                            <img src="assets/images/update-10-02-2023/resources/footer-widget-two-latest-news-img-1-2.jpg"
                                                alt="">
                                        </div>
                                        <div class="footer-widget-two__latest-news-content">
                                            <p class="footer-widget-two__latest-news-date">20 Jan, 2023</p>
                                            <h4 class="footer-widget-two__latest-news-title"><a
                                                    href="news-details.html">Lorem ipsum dolor <br> sit amet</a></h4>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="site-footer-two__bottom-inner">
                                <p class="site-footer-two__bottom-text">© All Copyright 2023 by <a
                                        href="#">Insur.com</a>
                                </p>
                            </div>
                        </div>
        ...
        <div class="mobile-nav__content mobile-nav__content--two">
            ...
            <div class="logo-box">
                <a href="index.html" aria-label="logo image"><img
                        src="assets/images/update-10-02-2023/resources/logo-3.png" width="143" alt="" /></a>
            </div>
            <!-- /.logo-box -->
...
<!-- Mirrored from layerdrops.com/insur/main-html/index4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jul 2023 02:51:34 GMT -->
</html>