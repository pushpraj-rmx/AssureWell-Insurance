...
<!-- Mirrored from layerdrops.com/insur/main-html/index5.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jul 2023 02:51:34 GMT -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title> Home Five || Insur || Insur HTML 5 Template </title>
    <!-- favicons Icons -->
                        ...
                        <div class="main-menu-five__wrapper-inner">
                            <div class="main-menu-five__left">
                                <div class="main-menu-five__logo">
                                    <a href="index.html"><img src="assets/images/update-10-02-2023/resources/logo-4.png"
                                            alt=""></a>
                                </div>
                            ...
                            <div class="main-menu-five__right">
                                <div class="main-menu-five__search-get-quote-btn">
                                    ...
                                    <div class="main-menu-five__get-quote-btn-box">
                                        <a href="contact.html" class="thm-btn-two main-menu-five__get-quote-btn">Get a
                                            Quote</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="testimonial-five__single">
                            ...
                            <div class="testimonial-five__client-info">
                                <div class="testimonial-five__client-img">
                                    <img src="assets/images/update-10-02-2023/testimonial/testimonial-5-1.jpg" alt="">
                                </div>
                            ...
                            <div class="footer-widget__column footer-widget-three__about">
                                <div class="footer-widget-three__logo">
                                    <a href="index.html"><img
                                            src="assets/images/update-10-02-2023/resources/footer-logo-2.png"
                                            alt=""></a>
                                </div>
                                ...
                                <div class="footer-widget-three__btn-box">
                                    <a href="contact.html" class="thm-btn-two footer-widget-three__btn">Get a Quote</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <ul class="footer-widget-three__latest-news-list list-unstyled clearfix">
                                    <li>
                                        <div class="footer-widget-three__latest-news-img">
                                            <img src="assets/images/update-10-02-2023/resources/footer-widget-three-latest-news-img-1-1.jpg"
                                                alt="">
                                        </div>
                                    ...
                                    <li>
                                        <div class="footer-widget-three__latest-news-img">
                                            <img src="assets/images/update-10-02-2023/resources/footer-widget-three-latest-news-img-1-2.jpg"
                                                alt="">
                                        </div>
                                        <div class="footer-widget-three__latest-news-content">
                                            <p class="footer-widget-three__latest-news-date">20 Jan, 2023</p>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="site-footer-three__bottom-inner">
                                <p class="site-footer-three__bottom-text">© All Copyright 2023 by <a
                                        href="#">Insur.com</a>
                                </p>
...
<!-- Mirrored from layerdrops.com/insur/main-html/index5.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jul 2023 02:52:04 GMT -->
</html>