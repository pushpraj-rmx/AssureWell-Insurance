...
<!-- Mirrored from layerdrops.com/insur/main-html/portfolio.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jul 2023 02:55:38 GMT -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title> Portfolio || Insur || Insur HTML 5 Template </title>
    <!-- favicons Icons -->
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra poli">
                        <div class="portfolio__single">
                            <div class="portfolio__img">
                                ...
                                <div class="portfolio__plus">
                                    <a href="assets/images/project/portfolio-1-5.jpg" class="img-popup"><span
                                            class="icon-plus"></span></a>
                                </div>
                                <div class="portfolio__content">
                                    <p class="portfolio__sub-title">Strategy</p>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 filter-item insur busi">
                        <div class="portfolio__single">
                            <div class="portfolio__img">
                                ...
                                <div class="portfolio__plus">
                                    <a href="assets/images/project/portfolio-1-6.jpg" class="img-popup"><span
                                            class="icon-plus"></span></a>
                                </div>
                                <div class="portfolio__content">
                                    <p class="portfolio__sub-title">Strategy</p>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra busi">
                        <div class="portfolio__single">
                            <div class="portfolio__img">
                                ...
                                <div class="portfolio__plus">
                                    <a href="assets/images/project/portfolio-1-7.jpg" class="img-popup"><span
                                            class="icon-plus"></span></a>
                                </div>
                                <div class="portfolio__content">
                                    <p class="portfolio__sub-title">Strategy</p>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 filter-item stra poli">
                        <div class="portfolio__single">
                            <div class="portfolio__img">
                                ...
                                <div class="portfolio__plus">
                                    <a href="assets/images/project/portfolio-1-8.jpg" class="img-popup"><span
                                            class="icon-plus"></span></a>
                                </div>
                                <div class="portfolio__content">
                                    <p class="portfolio__sub-title">Strategy</p>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 filter-item poli busi">
                        <div class="portfolio__single">
                            <div class="portfolio__img">
                                ...
                                <div class="portfolio__plus">
                                    <a href="assets/images/project/portfolio-1-9.jpg" class="img-popup"><span
                                            class="icon-plus"></span></a>
                                </div>
                                <div class="portfolio__content">
                                    <p class="portfolio__sub-title">Strategy</p>
...
<!-- Mirrored from layerdrops.com/insur/main-html/portfolio.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jul 2023 02:55:47 GMT -->
</html>