...
<!-- Mirrored from layerdrops.com/insur/main-html/make-a-claim-loan.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jul 2023 02:56:45 GMT -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title> Make a Claim || Insur || Insur HTML 5 Template </title>
    <!-- favicons Icons -->
        ...
        <section class="page-header">
            ...
            <div class="container">
                <div class="page-header__inner">
                    ...
                    <h2>Loan against insurance policy</h2>
                </div>
            </div>
        </section>
        <!--Page Header End-->
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-7">
                        <div class="make-a-claim__left">
                            <h3 class="make-a-claim__title-1">Loan against insurance policy</h3>
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="make-a-claim__img">
                                            <img src="assets/images/update-10-02-2023/resources/make-a-claim-img-3.jpg"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                            ...
                            <div class="make-a-claim__procedure-box">
                                <div class="make-a-claim__procedure-shape-1">
                                    <img src="assets/images/update-10-02-2023/shapes/make-a-claim-procedure-shape-1.png"
                                        alt="">
                                </div>
                        ...
                        <div class="make-a-claim__right">
                            <div class="make-a-claim__claim-box">
                                <ul class="make-a-claim__claim-list list-unstyled">
                                    <li>
                                        <a href="make-a-claim-death.html">Death Claim<span
                                                class="icon-right-arrow1"></span></a>
                                    </li>
                                    <li>
                                        <a href="make-a-claim-maturity.html">Maturity Claims<span
                                                class="icon-right-arrow1"></span></a>
                                    </li>
                                    <li>
                                        <a href="make-a-claim-group.html">Group & Pension Claims<span
                                                class="icon-right-arrow1"></span></a>
                                    </li>
                                    <li>
                                        <a href="make-a-claim-other.html">Other Claims<span
                                                class="icon-right-arrow1"></span></a>
                                    </li>
                                    <li>
                                        <a href="make-a-claim-loan.html">Loan Against Insurance Policy<span
                                                class="icon-right-arrow1"></span></a>
                                    </li>
                                </ul>
                            </div>
...
<!-- Mirrored from layerdrops.com/insur/main-html/make-a-claim-loan.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Jul 2023 02:56:46 GMT -->
</html>